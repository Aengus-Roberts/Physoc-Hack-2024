...
declare class Fra<S, T> implements IFra<S, T> {
     ...
     */
    field<TKey extends keyof T>(fieldName: TKey, callback: (sourceValue: S) => T[TKey]): Fra<S, T>;
    /**
     ...
     */
    map(sourceValue: S, initialTarget?: T): T;
    /**
